...
//     maybeUpdateReadmeTable(badData, oldTable, count, COUNT_TYPE.TODO.type)
//   )
...
//   const actualError = t.throws(() =>
//     maybeUpdateReadmeTable(data, badOldTable, count, COUNT_TYPE.TODO.type)
//   )
//   t.is(actualError.message, expectedErrorMessage)
// })
...
//   const actualError = t.throws(() =>
//     maybeUpdateReadmeTable(data, oldTable, badCount, COUNT_TYPE.TODO.type)
//   )
//   t.is(actualError.message, expectedErrorMessage)
// })
...
//   const actualError = t.throws(() =>
//     maybeUpdateReadmeTable(data, oldTable, count, badCountType)
//   )
//   t.is(actualError.message, expectedErrorMessage)
// })
